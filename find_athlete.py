...
def main():
    ...
    if not user:
        ...
        bd_athlete, bd = nearest_by_bd(user)
        height_athlete, height = nearest_by_height(user, session)
        print("NBirthdate: {} | Birthdate: {}".format(bd_athlete, bd))
        print("NHeight: {} | Height: {}".format(height_athlete, height))
